...
const ListThumbnail = React.memo(function ListThumbnail({
  ...
  return (
    <View className="flex-row items-center py-4 px-4 bg-transparent border-b border-atelier-separator dark:border-atelier-separator-dark">
      <View className="w-14 h-14 rounded-full border-2 border-atelier-border dark:border-atelier-border-dark bg-atelier-bg-elevated dark:bg-atelier-bg-elevated-dark mr-3 overflow-hidden">
